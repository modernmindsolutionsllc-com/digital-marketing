...
function ServiceGroup({ group, index }) {
  return (
    <Reveal delay={index * 0.06}>
      <article className="grid gap-8 border-t border-white/10 py-10 lg:grid-cols-[0.86fr_1.14fr] lg:gap-12">
        <div>
          <span className="eyebrow">{group.eyebrow}</span>
          <h3 className="font-display mt-5 max-w-xl text-3xl font-semibold tracking-tight text-white sm:text-4xl">
            {group.title}
          </h3>
          <p className="mt-4 max-w-xl text-base leading-8 text-slate-300">{group.description}</p>

          <div className="media-frame mt-7">
    ...
    <Reveal delay={index * 0.08}>
      <article className="case-study-card">
        ...
        <div className="relative z-10 flex h-full flex-col justify-end">
          ...
          <h3 className="font-display mt-4 max-w-sm text-3xl font-semibold tracking-tight text-white">
            {study.title}
          </h3>
          <p className="mt-4 max-w-md text-sm leading-7 text-slate-200">{study.summary}</p>

          <div className="mt-7 flex items-end justify-between gap-6 border-t border-white/15 pt-5">
            <div>
              <p className="font-display text-4xl font-semibold text-white">{study.metric}</p>
              <p className="mt-2 text-sm text-slate-300">{study.result}</p>
            </div>
            <a href="#audit" className="inline-flex items-center gap-2 text-sm font-semibold text-white">
  ...
  return (
    <Reveal delay={index * 0.06}>
      <article className="insight-panel">
        ...
        <p className="mt-5 text-xs font-semibold uppercase tracking-[0.24em] text-cyan-200">{insight.category}</p>
        <h3 className="mt-3 text-2xl font-semibold tracking-tight text-white">{insight.title}</h3>
        <p className="mt-4 text-sm leading-7 text-slate-300">{insight.excerpt}</p>
      </article>
    </Reveal>
  );
}
...
export default function App() {
  return (
    <div className="relative overflow-x-clip">
      ...
      <main>
        <section id="home" className="relative isolate min-h-[calc(100svh-5rem)] overflow-hidden">
          <img
          ...
          <div className="section-shell relative flex min-h-[calc(100svh-5rem)] items-center py-16 sm:py-20 lg:py-24">
            <div className="grid w-full gap-12 lg:grid-cols-[0.86fr_1.14fr] lg:items-center">
              <Reveal>
                <div className="max-w-2xl">
                  ...
                  <h1 className="font-display mt-6 text-5xl font-semibold tracking-[-0.04em] text-white sm:text-6xl lg:text-[5.45rem] lg:leading-[0.96]">
          ...
          <div className="grid gap-12 lg:grid-cols-[0.84fr_1.16fr]">
            <Reveal>
              <div className="lg:sticky lg:top-28">
                ...
                <h2 className="font-display mt-5 max-w-xl text-4xl font-semibold tracking-tight text-white sm:text-5xl">
            ...
            <div className="space-y-8">
              {operatingPrinciples.map((principle, index) => (
                <Reveal key={principle.label} delay={index * 0.05}>
                  <article className="border-t border-white/10 pt-6">
                    <p className="text-xs font-semibold uppercase tracking-[0.24em] text-cyan-200">{principle.label}</p>
                    <p className="mt-3 max-w-2xl text-2xl leading-9 text-white sm:text-[1.7rem] sm:leading-10">
                      {principle.value}
                    </p>
                  </article>
                </Reveal>
              ...
              <div className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-6 sm:p-8">
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-cyan-200">Delivery rhythm</p>
              ...
              <div className="grid gap-0 lg:grid-cols-[0.78fr_1.22fr]">
                <div className="relative overflow-hidden border-b border-white/10 p-8 sm:p-10 lg:border-b-0 lg:border-r">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mt-10 rounded-[1.5rem] border border-white/10 bg-slate-950/45 p-5">
